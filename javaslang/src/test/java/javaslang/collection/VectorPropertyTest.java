...
public class VectorPropertyTest {
    ...
    public void shouldCreateAndGet() {
        for (int i = 0; i < 2000; i++) {
            ...
            final Vector<Character> actualChar = Vector.ofAll(LeafType.<char[]> asPrimitives(char.class, expectedChar));
            ...
            final Vector<Double> actualDouble = Vector.ofAll(LeafType.<double[]> asPrimitives(double.class, expectedDouble));
    ...
    public void shouldIterate() {
        ...
        Vector<Integer> actual = Vector.ofAll(LeafType.<int[]> asPrimitives(int.class, expected));
        ...
        for (int i = 1; i < 10; i++) {
            ...
            for (int j = 0; j < 50_000; j++) {
                ...
                if (percent(random) < 20) {
                    ...
                    actual = isPrimitive ? Vector.narrow(Vector.ofAll(LeafType.<int[]> asPrimitives(int.class, values))) : Vector.ofAll(values);
